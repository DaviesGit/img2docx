...
将图片序列依次转换为文档的背景图片，与[ImageMagick](https://www.imagemagick.org/)搭配使用可以实现将docx文档或者pdf文档转化为只读的不可复制的docx文档。
...
1. 使用以下命令将图片序列转换为docx文档。

```sh
./img2docx.sh image_sequence*.png output.docx
```
